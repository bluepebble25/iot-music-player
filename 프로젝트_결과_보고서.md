...
<hr>
<ol><strong>6. 아쉬운 점 </strong></br></br>
<ul><img width="749" alt="아쉬운점1" src="https://user-images.githubusercontent.com/80368992/145024254-b5e9384e-45ed-45af-9af7-76e1f6ba59e1.PNG"></ul></br>
<ul>휴 전구가 잘 작동하는지 확인하기 위해 필요한 모든 준비를 다 했지만 </br> 휴 브리지를 찾을 수 없다고 하며 잘 작동하는지 모르는 상황에서 구현을 하기 어려웠다.</ul></br> 

<ul><img width="433" alt="아쉬운점2" src="https://user-images.githubusercontent.com/80368992/145024267-9f537b60-64bd-49cb-957d-e7620f9d0ed7.PNG"></ul></br>
<ul> 어떤 표정인지 예측하기 위해 필요한 scikit-learn 라이브러리는 파이썬에서 가장 유명한 </br> 머신러닝 라이브러리 중 하나로 분류, 회귀, 군집화, 의사결정 트리 등의 </br>
다양한 머신러닝 알고리즘을 적용할 수 있는 함수들을 제공하는데 VNC뷰어로 라즈베리 파이와 노트북을 연결하여 </br> 통신하기 위한 준비를 했지만 </br>
이 라이브러리가 라즈베리 파이에 설치가 안돼서 구현한 파이썬 파일을 라즈베리 파이 환경에서 실행할 수 없었다 </ul></br></ol>
